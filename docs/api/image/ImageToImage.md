...
**模块**：`mosaic.nodes.image.image_to_image`
**继承**：`BaseImageNode`
...
|---|---|
| `name` | `'image-to-image'` |
| `description` | `"Transform an input image based on a text prompt using SDXL Img2Img. The 'strength' parameter controls the degree of modification."` |
| `version` | `'0.1.0'` |
...
### `__init__(self, model: 'str' = 'stabilityai/stable-diffusion-xl-refiner-1.0', **kwargs: 'Any') -> 'None'`
